...
if (typeof window === 'undefined') { // If not running in browser...
                    ...
                    Object.getOwnPropertyNames(resObj).forEach(function(venueId, index, array) {
                        ...
                        if (venue.events && venue.events.data.length > 0) {
                            ...
                            venue.events.data.forEach(function(event, index, array) {
                                ...
                                var place = {};
                                if(event.place) place = event.place;
                                ...
                                eventResultObj.distance = (place.location ? (self.haversineDistance([place.location.latitude, place.location.longitude], [self.latitude, self.longitude], false)*1000).toFixed() : null);
